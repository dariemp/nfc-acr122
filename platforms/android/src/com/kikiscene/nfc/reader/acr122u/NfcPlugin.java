package com.kikiscene.nfc.reader.acr122u;
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        reader.setOnStateChangeListener(new Reader.OnStateChangeListener() {
            ...
            public void onStateChange(int slotNumber, int previousState, int currentState) {
                Log.d(TAG, "Executing onStateChange()...");
                ...
                if (currentState == Reader.CARD_PRESENT) {
                    ...
                    Log.d(TAG, "Card Lost");
                    PluginResult result = new PluginResult(PluginResult.Status.OK, "Waiting...");
                    result.setKeepCallback(true);
                    callback.sendPluginResult(result);
                }
        ...
        Log.d(TAG, "Register receiver for USB permission...");
...
//    }
    ...
    private void listen(CallbackContext callbackContext) {
        Log.d(TAG, "Listening...");
        Log.d(TAG, "Getting USB devices...");
        Map<String, UsbDevice> devices = usbManager.getDeviceList();
        Log.d(TAG, "Getting first USB device...");
        UsbDevice device = devices.values().toArray(new UsbDevice[0])[0];
        Log.d(TAG, "Get permission for USB devices...");
        usbManager.requestPermission(device, mPermissionIntent);

        Log.d(TAG, "Preparing result for sending to UI...");
